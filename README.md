...
*  **`requirements.csv`**: Archivo principal que contiene los 20 requisitos funcionales formateados como Preguntas de Competencia (Competency Questions) siguiendo la metodología NeOn/Methontology.
